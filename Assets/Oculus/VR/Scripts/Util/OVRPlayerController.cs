...
public class OVRPlayerController : MonoBehaviour
{
	...
	/// </summary>
	public float BackAndSideDampen = 0.9f;
	...
	public virtual void UpdateMovement()
	{
		...
		if (EnableLinearMovement)
		{
			...
			if (moveForward)
				MoveThrottle += ort * (transform.lossyScale.z * moveInfluence * 0.5f * Vector3.forward);
			if (moveBack)
			...
			footstepAudio.enabled = (moveForward || moveBack || moveLeft || moveRight);
